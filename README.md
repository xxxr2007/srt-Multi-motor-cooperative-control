...
│                   weekly_tasks/ 每周任务文件夹（W0–W13 执行表 weekly_tasks.md）；开题/结题材料
...
| [weekly_tasks/weekly_tasks.md](docs/weekly_tasks/weekly_tasks.md) | 周任务表（W0–W13 初稿，从 three_month_plan 复制，组长直接在此改） |
